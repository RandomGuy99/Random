...
public class FlowServiceImpl  implements FlowService {
	...
	private TopologyResponse populateTopologyData(NeatInfo neatInfo) {
		...
		List<PortCardInfo> slotInfoList = new ArrayList<PortCardInfo>();
		...
		portInfo.setId("EV-123|1|4|9");
		portInfo.setLabel("Port(9)");
		portInfo.set_class("PORT");		
		portInfoList.add(portInfo);
		
		portCardInfo.setId("EV-123|1|4");
		portCardInfo.setLabel("Card(4)");
		portCardInfo.set_class("CARD");		
		portCardInfo.setChildren(portInfoList);
		slotInfoList.add(portCardInfo);
		portInfoList = new ArrayList<PortInfo>();
		
		portInfo = new PortInfo();		
		portInfo.setId("EV-123|1|3|6");
		portInfo.setLabel("Module(6)");
		portInfo.set_class("MODULE");
		portInfoList.add(portInfo);	
		
		portCardInfo = new PortCardInfo();
		portCardInfo.setId("EV-123|1|3");
		portCardInfo.setLabel("Card(3)");
		portCardInfo.set_class("CARD");		
			
		portCardInfo.setChildren(portInfoList);
		slotInfoList.add(portCardInfo);
		
		slotInfo.setId("EV-123|1");
		slotInfo.setLabel("SLOT-1");
		slotInfo.set_class("SLOT");
		slotInfo.setChildren(slotInfoList);
		shelfInfoList.add(slotInfo);
		
		shelfInfo.setId("EV-123");
		shelfInfo.setLabel("Shelf-123");
		shelfInfo.set_class("SHELF");
        shelfInfo.setChildren(shelfInfoList);
        equipNodeInfoList.add(shelfInfo);
        
        equipNodeInfo.setId("SF0c00d645-c432-4044-9caf-52d88d9018b5-SF1d1538b3-fa8e-458e-b711-5bf819e455fa");
        equipNodeInfo.setLabel("BFLONYFR-0771904A (MUX)");
        equipNodeInfo.set_class("SFNode");
        equipNodeInfo.setChildren(equipNodeInfoList);
        equipviewInfoList.add(equipNodeInfo);
          
        equipView.setId("SF0c00d645-c432-4044-9caf-52d88d9018b5");
        equipView.setLabel("BFLONYFR-0771904A");
